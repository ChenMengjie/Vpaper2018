...
load("Chu_cell_type_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary1[, -c(1:2)] <- apply(correlation.summary1[, -c(1:2)], 2, function(x){round(x, 3)})

aa <- correlation.summary1

load("Chu_time_course_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary1[, -c(1:2)] <- apply(correlation.summary1[, -c(1:2)], 2, function(x){round(x, 3)})

aa2 <- correlation.summary1

load("Grun_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary1[, -c(1:2)] <- apply(correlation.summary1[, -c(1:2)], 2, function(x){round(x, 3)})

aa3 <- correlation.summary1
  
load("Shalek_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary1[, -c(1:2)] <- apply(correlation.summary1[, -c(1:2)], 2, function(x){round(x, 3)})
...
load("Chu_cell_type_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary2[, -c(1:2)] <- apply(correlation.summary2[, -c(1:2)], 2, function(x){round(x, 3)})

aa <- correlation.summary2


load("Chu_time_course_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary2[, -c(1:2)] <- apply(correlation.summary2[, -c(1:2)], 2, function(x){round(x, 3)})

aa2 <- correlation.summary2


load("Grun_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary2[, -c(1:2)] <- apply(correlation.summary2[, -c(1:2)], 2, function(x){round(x, 3)})

aa3 <- correlation.summary2 
  
load("Shalek_downsampling_uniform_comparison_summary_CorL1L2")
correlation.summary2[, -c(1:2)] <- apply(correlation.summary2[, -c(1:2)], 2, function(x){round(x, 3)})

aa4 <- correlation.summary2
...
save(correlation.total, correlation2.total, L1.total, L1_2.total, file = "downsampling.uniform.corL1L2.for.plot")


load("downsampling.uniform.corL1L2.for.plot")
...
ggsave(p, file="Figure3B.downsampling.uniform.corL1L2_sum.pdf", width = 10, height = 8)
...
ggsave(p, file="FigureS6B.downsampling.uniform_L1_.corL1L2_sum.pdf", width = 10, height = 8)
