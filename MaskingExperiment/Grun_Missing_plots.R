...
load("Grun_imputation_with_missing2_summary")
...
load("Grun_imputation_with_missing5_summary")
...
load("Grun_imputation_with_missing10_summary")
...
ggsave(gg, file = paste0("Grun_missing_correlation_summary.pdf"), width = 12, height = 4)
...
ggsave(gg, file = paste0("Grun_missing_square_loss_summary.pdf"), width = 12, height = 4)
...
ggsave(gg, file = paste0("Grun_missing_l1_loss_summary.pdf"), width = 12, height = 4)
