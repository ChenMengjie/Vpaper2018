...
for(i in 1:10){
	 load(paste0("grun_missing2_copy", i, "_imputation.summary"))
...
absolute.loss.median.summary <- data.frame(dataset = rep("Grun", nrow(all.res)), 
...
square.loss.median.summary <- data.frame(dataset = rep("Grun", nrow(all.res)), 
           scenario = rep("missing2", nrow(all.res)),
           scimpute = all.res[, 1],
           lnpX = all.res[, 2], 
           saver = all.res[, 5],
...
correlation.median.summary <- data.frame(dataset = rep("Grun", nrow(all.res)), 
           scenario = rep("missing2", nrow(all.res)),
           scimpute = all.res[, 1],
           lnpX = all.res[, 2], 
           saver = all.res[, 5],
...
save(correlation.median.summary, square.loss.median.summary, absolute.loss.median.summary, file = "Grun_imputation_with_missing2_summary")
...
for(i in 1:10){
	 load(paste0("grun_missing5_copy", i, "_imputation.summary"))
	 log.topredict <- log(topredict+1)
	 log.scimpute.pred <- log(scimpute.pred+1)
	 log.lnpX.pred <- lnpX.pred
	 log.imputed.pred <- log(exp(imputed.pred)-0.1+1)
...
save(correlation.median.summary, square.loss.median.summary, absolute.loss.median.summary, file = "Grun_imputation_with_missing5_summary")
...
for(i in 1:10){
	 load(paste0("grun_missing10_copy", i, "_imputation.summary"))
	 log.topredict <- log(topredict+1)
	 log.scimpute.pred <- log(scimpute.pred+1)
	 log.lnpX.pred <- lnpX.pred
	 log.imputed.pred <- log(exp(imputed.pred)-0.1+1)
...
save(correlation.median.summary, square.loss.median.summary, absolute.loss.median.summary, file = "Grun_imputation_with_missing10_summary")
